...
const Login = () => {
  ...
  return (
    <div className='h-screen bg-[#0c0a09] flex flex-col'>
      <AuthNavbar />
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-6'>
            ...
            <div>
              <input
                ...
                className={`w-full bg-g[#0c0a09] text-black p-4 py-2 rounded-lg border border-gray-700 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all ${
            ...
            <button
              type='submit'
              className='bg-white text-[#0c0a09] px-4 py-2 rounded-lg w-full '
            >
              Login
            </button>
          </form>
