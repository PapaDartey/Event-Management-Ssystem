...
const Home = () => {
  ...
  const pageVariants = {
    initial: { opacity: 0, backgroundColor: "#0c0a09" }, // Dark background
    animate: {
      opacity: 1,
      transition: {
        duration: 0.8,
  ...
  return (
    <motion.div
      ...
      animate='animate'
      exit='exit'
      className='min-h-screen bg-[#0c0a09] text-gray-100'
    >
      <Navbar />
      <Hero/>
                    ...
                    >
                      {filteredEvents.map((event, index) => (
                        <motion.div
                          ...
                          whileTap={{ scale: 0.98 }}
                          className='bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-700'
                        >
                          <EventCard
                            id={event._id}
